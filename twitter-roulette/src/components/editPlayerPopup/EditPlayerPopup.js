...
export default function EditPlayerPopup(props) {
    ...
    function changeUserData() {
        console.log("ESTADOS INTERMEDIARIOS");
        console.log(editedImg, editedName, editedAccount);
        props.editUser(editedImg, editedName, editedAccount);

        props.toggleEditPlayerPopup();
    }
                        ...
                        <div className="edit-player-info">
                            ...
                            <div className="edit-player-data-container">
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        setEditedAccount(event.target.value)
                                    }
                                    value={editedAccount}
                                />
                            </div>
